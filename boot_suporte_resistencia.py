...
API_SECRET = ''
MERCADO = 'BUSD';
PAR_MOEDA_NEGOCIACAO = 'SHIB';
SYMBOL = PAR_MOEDA_NEGOCIACAO+MERCADO;
ORCAMENTO_MOEDA_NEGOCIACAO = 21; #MINIMO 12 BUSD
GERENCIAR_BANCA_MOEDA_NEGOCIACAO = False; # Se for true gerencia toda a carteira da moeda de negociaçao se for falsa limita ao orcamento definido
UID = '001'

client = Client(API_KEY, API_SECRET, tld='com')
symbolTicker = SYMBOL
quantityOrders = ORCAMENTO_MOEDA_NEGOCIACAO
...
while 1:
    ...
    print("***** " + symbolTicker + " *******")
    print("Média MA50 " + str(round(ma50,8)))
    print("Preço Atual " + str(round(symbolPrice,8)))
    print("Preço Para Compra " + str(round(ma50*0.995,8)))
